...
using ExcelSheetExtensionClasses;
using System;
using System.Data;
...
namespace ExcelSheetExtensionClasses.Tests
{
    [TestClass()]
    public class UtilsTests
    {
        ...
        public void ReadSAXRangeTest()
        {
            ...
            /*
            string[] vArray = validationValue.Split(new string[]{Environment.NewLine}, StringSplitOptions.None).ToArray();
            string[] dArray = dtReceived.Split(new string[] { Environment.NewLine }, StringSplitOptions.None).ToArray();

            for(int i=0;i<vArray.Length;i++)
            {
                int areEqual = String.CompareOrdinal(vArray[i], dArray[i]);
            }
            */